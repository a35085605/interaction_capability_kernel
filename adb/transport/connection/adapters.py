...
class SubprocessAdbTransport:
    ...
    def connect(self, operation: AdbTcpConnect) -> NativeAttemptResult:
        ...
        return run_adb(self.executable, self.timeout_seconds, [*server_args(self.configuration), "connect", operation.address])
    ...
    def disconnect(self, operation: AdbTcpDisconnect) -> NativeAttemptResult:
        ...
        return run_adb(self.executable, self.timeout_seconds, [*server_args(self.configuration), "disconnect", operation.address])
    ...
    def reconnect(self, operation: AdbTransportReconnect) -> NativeAttemptResult:
        ...
        return run_adb(self.executable, self.timeout_seconds, [*server_args(self.configuration), *selector_args(operation.selector), "reconnect"])
    ...
    def reconnect_device(self, operation: AdbDeviceSideReconnect) -> NativeAttemptResult:
        ...
        return run_adb(self.executable, self.timeout_seconds, [*server_args(self.configuration), *selector_args(operation.selector), "reconnect", "device"])
    ...
    def reconnect_offline(self, operation: AdbOfflineTransportsReconnect) -> NativeAttemptResult:
        ...
        return run_adb(self.executable, self.timeout_seconds, [*server_args(self.configuration), "reconnect", "offline"])
